...
public class AddNewColumnTest {
    ...
    void addNewColumn() {
        ...
        // Then "New Column 1" is shown in the last row of the table
        WebElement tableData = wait.until(ExpectedConditions
                .visibilityOfElementLocated(By.xpath("//table//tbody//tr[last()]//td[1]")));
        Assertions.assertTrue(tableData.getText().contains("New Column 1"));
