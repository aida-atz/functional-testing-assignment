...
public class AddEmptyProjectTest {
    ...
    void addEmptyProjectFails() {
        ...
        WebElement saveButton = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='form-actions']//button")));
        saveButton.click();

        // Then "The project name is required" is shown below the "Name" field
        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//ul[@class='form-errors']//li")));
        Assertions.assertEquals(errorMsg.getText(), "The project name is required");
